  ...
  education: [
    {
      ...
      lead: { name: 'Camila Souza', data: { course: 'Enfermagem', shift: 'manhã', document: 'CPF' }, status: 'NOVO' },
      history: [
        ...
        { from: 'ai',   text: 'Temos Enfermagem como principal opção na área da saúde. Posso te mandar o PDF do curso e, se fizer sentido, já inicio sua matrícula por aqui.', minutesAgo: 45 },
        { from: 'user', text: 'Enfermagem mesmo', minutesAgo: 44 },
        { from: 'ai',   text: 'Perfeito. Para eu montar certinho: você prefere estudar de manhã, à tarde ou à noite?', minutesAgo: 43 },
        { from: 'user', text: 'Manhã, fica melhor por causa do trabalho', minutesAgo: 42 },
        { from: 'ai',   text: 'Ótimo. Pode me mandar seu nome completo para eu começar a ficha?', minutesAgo: 41 },
        { from: 'user', text: 'Camila Souza', minutesAgo: 40 },
        { from: 'ai',   text: 'Perfeito, Camila. Se preferir, pode enviar CPF e RG juntos ou mandar um PDF com tudo depois.', minutesAgo: 39 },
        { from: 'user', text: 'Vou mandar em PDF único', minutesAgo: 38 },
        { from: 'ai',   text: 'Fechado, Camila. Já deixei Enfermagem pela manhã anotado e sigo com você até concluir a matrícula.', minutesAgo: 37 },
      ],
    },
    {
      id: 'c2', phone: '+55 (21) 97654-3210', city: 'Rio de Janeiro',
      lead: { name: 'Lucas Rodrigues', data: { course: 'Direito', shift: 'tarde', document: 'CPF' }, status: 'CONTATO' },
      history: [
        ...
        { from: 'ai',   text: 'Direito é uma ótima escolha. Tenho o PDF do curso e também consigo te explicar a condição à vista. Você quer estudar em qual turno?', minutesAgo: 127 },
        { from: 'user', text: 'À tarde', minutesAgo: 125 },
        { from: 'ai',   text: 'Combinado. Para seguir com a matrícula, qual é o seu nome completo?', minutesAgo: 124 },
        { from: 'user', text: 'Lucas Rodrigues', minutesAgo: 121 },
        { from: 'ai',   text: 'Obrigado, Lucas. Registrei Direito no turno da tarde. Agora posso seguir com seus dados pessoais e documentos.', minutesAgo: 120 },
        { from: 'user', text: 'Pode seguir por aqui mesmo', minutesAgo: 30 },
        { from: 'ai',   text: 'Perfeito. Se tiver CPF e RG em mãos eu valido agora; se preferir, pode mandar tudo em um único PDF.', minutesAgo: 29 },
      ],
    },
    {
      id: 'c3', phone: '+55 (31) 98123-4567', city: 'Belo Horizonte',
      lead: { name: 'Mariana Costa', data: { course: 'Administração', shift: 'tarde', document: 'CPF' }, status: 'INSCRITO' },
      history: [
        ...
        { from: 'ai',   text: 'Perfeito. Administração tem bastante saída para gestão e negócios. Quer que eu já te mostre valores e desconto à vista?', minutesAgo: 297 },
        { from: 'user', text: 'Quero sim', minutesAgo: 295 },
        ...
        { from: 'ai',   text: 'Tudo certo, Mariana. Deixei Administração à tarde anotado e sigo com a coleta dos documentos por aqui.', minutesAgo: 288 },
    ...
    },
    {
      ...
      lead: { name: 'Thiago Martins', data: { course: 'Enfermagem', shift: 'tarde', document: 'CPF' }, status: 'MATRICULADO' },
      history: [
        ...
        { from: 'ai',   text: 'Boa tarde! Enfermagem tem turmas em diferentes turnos. Você prefere manhã, tarde ou noite?', minutesAgo: 597 },
        { from: 'user', text: 'Tarde por favor', minutesAgo: 595 },
        { from: 'ai',   text: 'Perfeito. Me manda seu nome completo para eu abrir sua ficha de matrícula?', minutesAgo: 594 },
        { from: 'user', text: 'Thiago Martins', minutesAgo: 590 },
        { from: 'ai',   text: 'Registrado, Thiago. Separei Enfermagem à tarde e finalizei o caminho de matrícula com você.', minutesAgo: 588 },
    ...
    },
    {
      ...
      lead: null,
      history: [
        { from: 'ai',   text: 'Oi! Quer saber valores, horário, localização, documentos ou já começar sua matrícula?', minutesAgo: 3 },
        { from: 'user', text: 'Oi, quero informação sobre Pedagogia', minutesAgo: 2 },
        { from: 'ai',   text: 'Pedagogia forma educadores para sala de aula, coordenação e projetos sociais. Quer que eu te envie o PDF do curso e veja valores?', minutesAgo: 1 },
      ],
    },
  ],
